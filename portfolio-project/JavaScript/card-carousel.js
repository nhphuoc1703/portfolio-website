...
leftArrow.addEventListener('click', () => {
    ...
    if (scrollPosition < 0) scrollPosition = carousel.scrollWidth - carousel.clientWidth;
...
rightArrow.addEventListener('click', () => {
    scrollPosition += cardWidth;
    if (scrollPosition >= carousel.scrollWidth - carousel.clientWidth) scrollPosition = 0;
    updateScroll(scrollPosition);
    updateIndicators();
});
...
function updateIndicators() {
    ...
    const activeIndex = Math.round(scrollPosition / cardWidth) % totalCards;
